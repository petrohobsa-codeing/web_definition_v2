...
export const defaultPosts: BlogPost[] = [
  {
    ...
    content: `تُعدّ الوساطة اللوجستية أحد أبرز العوامل التي تحدد نجاح مشاريع البناء والإنشاء في المملكة العربية السعودية. فبدلاً من أن تضطر كل شركة إنشاء إلى إدارة سلسلة التوريد بمفردها، تأتي شركات الوساطة مثل بتروهوب لتوفير الربط المباشر بين الموردين الموثوقين والمشاريع المحتاجة.
...
تعمل شركة بتروهوب كحلقة وصل استراتيجية في المملكة، مع تغطية تشمل الرياض، مكة المكرمة، المدينة المنورة، ينبع، وتبوك.`,
    category: "لوجستيات",
    date: "2025-06-01",
...
بتروهوب تضمن لك جميع هذه المعايير مع تغطية 24/7 للحالات الطارئة.`,
    category: "بيئة وصرف",
    date: "2025-05-20",
...
تُغطي بتروهوب الرياض، مكة المكرمة، المدينة المنورة، ينبع، وتبوك — مع إمكانية التنسيق لمناطق أخرى حسب الطلب.`,
    category: "إمداد مائي",
    date: "2025-05-10",
