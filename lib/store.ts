...
export const defaultServices: ServiceItem[] = [
  ...
  },
  {
    ...
    titleEn: "Energy Supply & Logistics Management",
    description: "تنفيذ منظم لا ينتهي عند توفير المنتج، يغطي نطاقًا واسعًا من الإمدادات مع إدارة لوجستية وتشغيلية متكاملة.",
    descriptionEn: "Organized execution that does not stop at product delivery, covering a wide supply scope with integrated logistics and operational management.",
  ...
  },
  {
    ...
    title: "Petrohob Monitor",
    titleEn: "Petrohob Monitor",
    description: "منتج تقني يبني رؤية موحدة للأصول والاستهلاك؛ راقب، قِس، واربط بياناتك في شاشة واحدة.",
    descriptionEn: "A technical product that builds a unified view of assets and consumption - monitor, measure and connect your data on one screen.",
...
export const defaultServiceDetails: ServiceDetailItem[] = [
  ...
  },
  {
        ...
        title: "إمدادات الطاقة والإدارة اللوجستية",
        titleEn: "Energy Supply & Logistics Management",
        intro: "تغطي Petrohob نطاقًا متنوعًا من احتياجات الطاقة والمياه، وتنسّق تنفيذها بما يراعي طبيعة الموقع، وحجم الطلب، ومتطلبات السلامة، وأولوية الاستمرارية. يمتد دورنا من تحديد الاحتياج حتى تنظيم الحركة والتسليم وإغلاق الطلب بصورة واضحة — تنفيذ منظم لا ينتهي عند توفير المنتج.",
        introEn: "Petrohob covers a diverse range of energy and water needs, coordinating delivery around site conditions, order size, safety requirements and continuity priorities. Our role extends from defining the need to organizing movement, delivery and clear order closeout - organized execution that does not stop at supplying the product.",
        advantages: ["غاز البترول المسال (LPG).", "المنتجات البترولية.", "الوقود الصناعي.", "البتروكيماويات.", "حلول المياه.", "الطاقة الاحتياطية."],
        advantagesEn: ["Liquefied petroleum gas (LPG).", "Petroleum products.", "Industrial fuel.", "Petrochemicals.", "Water solutions.", "Backup power."],
        ...
        valueEn: ["Management of transport and distribution operations.", "Planning, scheduling and coordination.", "Providing and leasing dedicated project transport per requirements.", "Tracking shipment movement and order status.", "Delivery and documentation management.", "Supporting the supply chain and connecting parties."],
  },
  {
        id: "9",
        slug: "monitor",
        ...
        title: "Petrohob Monitor",
        titleEn: "Petrohob Monitor",
        intro: "منتج تقني يبني رؤية موحدة للأصول والاستهلاك — راقب، قِس، واربط بياناتك في شاشة واحدة. يربط Petrohob Monitor مصادر البيانات والأجهزة والأنظمة التشغيلية ضمن واجهة موحدة، ليمنح المنشأة صورة لحظية عن مواد الطاقة والمياه والمركبات والأصول، ويُصمَّم نطاق النظام وفق احتياج كل منشأة.",
        introEn: "A technical product that builds a unified view of assets and consumption - monitor, measure and connect your data on one screen. Petrohob Monitor links data sources, devices and operational systems in a single interface, giving the facility a real-time picture of energy and water materials, vehicles and assets, with the system scope designed around each facility's needs.",
        ...
        advantagesEn: ["Tank level sensors and meters.", "Flow, pressure, temperature and consumption readings per application.", "GPS devices tracking vehicle movement and routes.", "Monitoring stoppages and field asset status."],
        ...
        valueEn: ["Fixed cameras and dash cams for visual context supporting follow-up and safety.", "Instant alerts when thresholds are exceeded.", "Dashboards, logs and reports supporting analysis and planning."],
  },
  ];
