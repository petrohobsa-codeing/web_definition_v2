...
export const defaultServices: ServiceItem[] = [
  {
    ...
    description:
      "نوصّل الديزل عالي الجودة لمولّداتك ومعداتك الثقيلة بأي كمية وفي أي موقع داخل المملكة. توصيل مجدول أو فوري مع فواتير ضريبية إلكترونية.",
  ...
  },
  {
    ...
    description:
      "أجهزة استشعار دقيقة تُثبَّت على خزاناتك لمراقبة المستوى لحظياً، مع تنبيهات فورية على جوّالك وطلب تلقائي عند الاقتراب من النفاد.",
  ...
  },
  {
    ...
    description:
      "حلول غاز مخصّصة للمنشآت الصناعية والتجارية بأعلى معايير السلامة، مع فحص دوري للتمديدات وامتثال كامل لاشتراطات الجهات الرسمية.",
  ...
  },
  {
    ...
    description:
      "منصة سحابية متكاملة تعرض بيانات كل خزاناتك ومواقعك في لوحة واحدة، مع تقارير الاستهلاك وتحليلات التكلفة وصلاحيات متعددة المستخدمين.",
