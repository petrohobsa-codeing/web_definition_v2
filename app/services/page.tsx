...
import { Fuel, Flame, ArrowLeft } from "lucide-react";

export const metadata: Metadata = {
  title: "الخدمات — Fast Link",
  description:
    "تزويد الديزل والبترول للمنشآت الصناعية والتجارية في جميع مناطق المملكة. توصيل موثوق مع فواتير ضريبية إلكترونية.",
};
...
const services = [
  ...
  },
  {
    ...
    title: "تزويد البترول",
    description:
      "توصيل البترول عالي الجودة للمنشآت الصناعية والتجارية وأساطيل النقل في جميع مناطق المملكة، بأعلى معايير الجودة والسلامة وفواتير ضريبية إلكترونية.",
    href: "/services/gas-supply",
    gradient: "from-amber-700 to-amber-500",
    features: ["جودة مضمونة وموثّقة", "فواتير ضريبية إلكترونية", "دعم طوارئ 24/7"],
  },
];
