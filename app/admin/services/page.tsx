        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-xs font-bold text-brand-charcoal mb-1.5">
                  الأيقونة (تُستخدم عند عدم وجود صورة)
                </label>
                <select
              ...
              <div>
                <label className="block text-xs font-bold text-brand-charcoal mb-1.5">
                  اسم الخدمة (إنجليزي — اختياري، يُترجم تلقائياً إن تُرك فارغاً)
                </label>
                <input
                  className={inputCls}
                  value={editing.titleEn || ""}
                  onChange={(e) => change("titleEn", e.target.value)}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => change("descriptionEn", e.target.value)}
