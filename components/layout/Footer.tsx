...
import { Fuel, Mail, Phone, MapPin, Clock, ExternalLink } from "lucide-react";
            ...
            <div className="flex gap-3">
              {socials.map((s) => (
                <a
                  ...
                  className="w-9 h-9 rounded-xl bg-white/10 flex items-center justify-center text-white/60 hover:bg-brand-green hover:text-white transition-all duration-200"
                >
                  {s.icon}
                </a>
              ))}
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-white/20 text-xs">مرخّص ومعتمد في المملكة العربية السعودية</span>
          </div>
        </div>
      </div>
    </footer>
