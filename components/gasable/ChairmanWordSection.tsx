...
const chairman = {
  ...
  ar: {
    ...
    paragraphs: [
      ...
      "من هذا الفهم انطلقت Petrohob لبناء أسلوب عمل يربط الاحتياج بالتخطيط والتنفيذ والمتابعة والتوثيق. هدفنا أن نخفف التعقيد عن العميل، وأن نجعل كل مرحلة أكثر وضوحًا؛ من لحظة استلام الطلب حتى إتمام التسليم، ثم تحويل ما يحدث ميدانيًا إلى بيانات تساعد على التخطيط والتحكم.",
      ...
      "طموحنا أن تكون Petrohob شريكًا مؤسسيًا يُعتمد عليه؛ داخل المملكة العربية السعودية وخارجها، وأن نسهم في بناء نموذج أكثر تطورًا لإدارة الطاقة، يقوم على الوضوح، والدقة، والاستجابة، والقيمة المستدامة.",
    ],
    name: "نايف بن حيدره",
  ...
  en: {
    ...
    paragraphs: [
      ...
      "From this understanding, Petrohob set out to build a way of working that links need to planning, execution, follow-up and documentation. Our goal is to take complexity off the client's shoulders and make every stage clearer — from the moment a request is received to the completion of delivery — then turn what happens on the ground into data that supports planning and control.",
      ...
      "Our ambition is for Petrohob to be a dependable institutional partner — inside the Kingdom of Saudi Arabia and beyond — and to contribute to building a more advanced model for energy management, one built on clarity, accuracy, responsiveness and sustainable value.",
    ],
